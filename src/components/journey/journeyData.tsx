...
export const journeySteps: JourneyStep[] = [
  ...
  },
  {
    ...
    progress: 5,
    animationFrames: animations.bjj,
    rewards: [
    ...
    specialItemFrames: animations.whiteBelt,
    specialItemRarity: "Common",
  ...
  },
  {
    ...
    progress: 5,
    animationFrames: animations.snakeWrestle,
    rewards: [
      { name: "Experience", amount: 3000, icon: <FaStar /> },
    ...
    specialItemFrames: animations.wrestleAmulet,
    specialItemRarity: "Common",
    prerequisites: ["The Herculean Trial"],
  },
    {
    title: "The Ivory Battlefield",
    date: "2020",
    location: "The Digital Arenas of Lichess",
    description: "You enter a timeless war waged on 64 squares. Here, intellect is the only weapon. Each game is a new story of sacrifice and strategy, a relentless climb from a novice rating of 940 towards the echelons of grandmasters.",
    questType: "The Scholar's Path",
    difficulty: "Normal",
    recommendedLevel: 18,
    recommendedSkills: ["Pattern Recognition", "Tactical Vision", "Patience"],
    progress: 40,
    animationFrames: animations.chess,
    rewards: [
      { name: "Experience", amount: 1500, icon: <FaStar /> },
      { name: "Opening Theory", icon: <FaBook /> },
      { name: "Endgame Strategy", icon: <FaBrain /> },
    ],
    specialItem: "Pawn's Promotion Charm",
    specialItemFrames: animations.pawn,
    specialItemRarity: "Common",
  },
  {
    title: "Forged in Iron",
    date: "2023",
    location: "The Iron Temples of London",
    description: "The path of the warrior demands more than just skill—it demands raw power. You commit to the Iron Rite, a trial of strength and discipline. After countless sessions, you achieve the first milestone: lifting the Centurion's weight of 100kg in the three sacred lifts.",
    questType: "The Way of the Warrior",
    difficulty: "Normal",
    recommendedLevel: 20,
    recommendedSkills: ["Strength Buff", "Discipline", "Proper Form"],
    progress: 100,
    animationFrames: animations.buffManSmall,
    rewards: [
      { name: "Experience", amount: 2000, icon: <FaStar /> },
      { name: "Foundational Strength", icon: <GiAnvil /> },
      { name: "Iron Will", icon: <FaBrain /> },
    ],
    specialItem: "Centurion's Plate",
    specialItemFrames: animations.bodyArmour,
    specialItemRarity: "Uncommon",
  ...
  },
  {
    ...
    date: "2025",
    location: "The Iron Temples of London",
    description: "The Centurion's Plate is but a memory. A new, legendary goal looms: to lift the Titan's Burden. The bar is set for a 200kg Squat, a 200kg Deadlift, and a 150kg Bench Press—numbers that will etch your name among the strongest warriors in the Iron Temple.",
    questType: "The Way of the Warrior",
    difficulty: "Heroic",
    recommendedLevel: 21,
    recommendedSkills: ["Foundational Strength", "Advanced Nutrition", "Unbreakable Will"],
    progress: 15,
    animationFrames: animations.buffMan,
    rewards: [
      { name: "Experience", amount: 7500, icon: <FaStar /> },
      { name: "Legendary Power", icon: <FaDumbbell /> },
      { name: "Aura of Strength", icon: <FaInfinity /> },
    ],
    specialItem: "The Titan's Pauldrons",
    specialItemFrames: animations.shoulderArmour,
    specialItemRarity: "Legendary",
    prerequisites: ["Forged in Iron"],
  },
  {
    title: "Breathing Life into Sprites",
    date: "2025",
    location: "The Digital Forge",
    description: "The Chronicler's Task requires more than just words; it needs a soul. You delve into the art of pixel alchemy, learning to animate the very sprites that will tell your story. Each frame is a careful incantation, breathing movement and personality into static images.",
    questType: "The Chronicler's Task",
    difficulty: "Easy",
    recommendedLevel: 21,
    recommendedSkills: ["Aseprite Grimoire", "Artistic Vision", "Patience"],
    progress: 25,
    animationFrames: animations.lsp,
    rewards: [
      { name: "Experience", amount: 1000, icon: <FaStar /> },
      { name: "Sprite Animation", icon: <FaPaintBrush /> },
      { name: "Visual Storytelling", icon: <FaBookOpen /> },
    ],
    specialItem: "Palette of Living Colors",
    specialItemFrames: animations.colours,
    specialItemRarity: "Rare",
    prerequisites: ["The Chronicler's Task"],
  },
    {
    ...
    progress: 67,
    animationFrames: animations.uni,
    rewards: [
    ...
    specialItemFrames: animations.degree,
    specialItemRarity: "Legendary",
    prerequisites: ["A Pilgrimage to the North"],
  },
  {
    ...
    progress: 12,
    animationFrames: animations.bountyHunter,
    rewards: [
    ...
    specialItemFrames: animations.bountyHunterHat,
    specialItemRarity: "Legendary",
  ...
  },
  {
    ...
    progress: 100,
    animationFrames: animations.convergenceGolem,
    rewards: [
    ...
    specialItemFrames: animations.convergenceCharm,
    specialItemRarity: "Rare",
    ...
    progress: 100,
    animationFrames: animations.spiderMan,
    rewards: [
    ...
    specialItemFrames: animations.webBook,
    specialItemRarity: "Common",
  ...
  },
  {
    ...
    progress: 80,
    animationFrames: animations.AIMan,
    rewards: [
      { name: "Experience", amount: 1500, icon: <FaStar /> },
    ...
    specialItemFrames: animations.goodCoin,
    specialItemRarity: "Uncommon",
  ...
  },
  {
    ...
    progress: 100,
    animationFrames: animations.moneyGolem,
    rewards: [
      { name: "Experience", amount: 5000, icon: <FaStar /> },
    ...
    specialItemFrames: animations.blackBox,
    specialItemRarity: "Epic",
  ...
  },
  {
    ...
    progress: 100,
    animationFrames: animations.imaginaryMan,
    rewards: [
      { name: "Experience", amount: 3000, icon: <FaStar /> },
    ...
    specialItemFrames: animations.residueScroll,
    specialItemRarity: "Epic",
  ...
  },
  {
    ...
    progress: 100,
    animationFrames: animations.mathMan,
    rewards: [
      { name: "Experience", amount: 2000, icon: <FaStar /> },
    ...
    specialItemFrames: animations.primeSieve,
    specialItemRarity: "Uncommon",
    prerequisites: ["The Trial of Infinite Sums"],
  },
  {
    ...
    progress: 32,
    animationFrames: animations.archLinuxMan,
    rewards: [
    ...
    specialItemFrames: animations.archLaptop,
    specialItemRarity: "Legendary",
  ...
  },
  {
    ...
    progress: 41,
    animationFrames: animations.WIP,
    rewards: [
      { name: "Experience", amount: 1000, icon: <FaStar /> },
